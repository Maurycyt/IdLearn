...
public class Operation extends CodeBlock {
	...
	public CodeData saveFormat() {
		CodeData resultData = new CodeData();
		resultData.type = BlockType.Operation;
		resultData.texts.add(result.getText());
		resultData.texts.add(oper1.getText());
		resultData.texts.add(dropDown.getValue());
		resultData.texts.add(oper2.getText());
		return resultData;
	}
}
